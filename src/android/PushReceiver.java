...
public class PushReceiver extends CordovaPlugin {
    private static CallbackContext callbackContext;

    @Override
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if ("onNotificationReceived".equals(action)) {
            PushReceiver.callbackContext = callbackContext;
            return true;
        }
        return false;
    }
   
    // public static void sendNotificationToJS(JSONObject data) {
